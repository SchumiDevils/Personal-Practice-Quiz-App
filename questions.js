...
const QUESTIONS = [
  ...
  },
  {
    ...
    "multiple": true,
    "explanation": "The increased demand for cybersecurity specialists offers several unique career opportunities.",
    "topic": "2.1.3",
    "type": "multi"
  },
  {
  ...
  {
    "id": 29,
    "question": "Your organization will be handling market trades. You will be required to verify the identify of each customer who is executing a transaction. Which technology should be implemented to authenticate and verify customer electronic transactions?",
    "options": [
      "data hashing",
  ...
  },
  {
    ...
    "multiple": false,
    "explanation": "A cybersecurity specialist needs to be familiar with the resources such as the CVE database, Infragard, and the NIST/NISE framework. All can be used to help plan and implement effective an information security management system.",
    "topic": "1.1.20",
    "type": "mcq"
  },
  {
    ...
    "multiple": false,
    "explanation": "System and data availability is a critical responsibility of a cybersecurity specialist. It is important to understand the technologies, process, and controls used to provide redundancy.",
    "topic": "12.6.7",
    "type": "mcq"
  },
  {
  ...
  },
  {
    ...
    "multiple": true,
    "explanation": "Network switches are the heart of the modern data communication network. The main threats to network switches are theft, hacking and remote access, and attacks against network protocols.",
    "topic": "9.2.2",
    "type": "multi"
  },
  {
  ...
  },
  {
    ...
    "multiple": false,
    "explanation": "Cybersecurity specialists need to be familiar with the characteristics of various attacks.",
    "topic": "1.3.4",
    "type": "mcq"
  },
  {
  ...
  {
    "id": 105,
    "question": "A router has an existing ACL that permits all traffic from 172.16.0.0\\. The administrator wants to block packets from host 172.16.0.1 but receives an error. What action can the administrator take?",
    "options": [
  ...
  },
  {
    ...
    "multiple": true,
    "explanation": "ACLs can be used for the following:Limit network traffic in order to provide adequate network performance Restrict the delivery of routing updates Provide a basic level of security Filter traffic based on the type of traffic being sent Filter traffic based on IP addressing",
    "topic": "14.1.1",
    "type": "multi"
  },
  {
    "id": 113,
    "question": "What is the investigator attempting to prove about the USB drive when the evidence is submitted in court?",
    "options": [
  ...
  {
    "id": 121,
    "question": "Refer to the exhibit. A security analyst is reviewing an alert message generated by Snort. What does the number 2100498 in the message indicate?",
    "options": [
  ...
  {
    "id": 122,
    "question": "What is an example of a privilege escalation attack?",
    "options": [
  ...
  {
    "id": 127,
    "question": "What is indicated by a Snort signature ID (SID) that is below 3464?",
    "options": [
  ...
  {
    "id": 133,
    "question": "The entrepreneur is concerned about employees having uninterrupted access to important resources and data. Which of the CIA triad components would address the concern?",
    "options": [
      "integrity",
      "authentication",
      "confidentiality",
  ...
  },
  {
    ...
    "multiple": false,
    "explanation": "The Security Guidance for Critical Areas of Focus in Cloud Computing v4 document developed by the Cloud Security Alliance (CSA) covers 14 domains of cloud security. Some of these domains are: * Infrastructure Security – describes cloud-specific aspects of infrastructure security and the foundation for operating securely in the cloud. * Data Security and Encryption – describes those controls related to securing the data itself, of which encryption is one of the most important. * Application Security – provides guidance on how to securely build and deploy applications in cloud computing environments, specifically for PaaS and IaaS. * Security as a Service – covers the continually evolving security services delivered from the cloud.",
    "topic": "17.2.1",
    "type": "mcq"
  },
  {
    ...
    "multiple": true,
    "explanation": "Software-defined networks (SDN) enable new types of security controls and provide an overall gain for network security including: * easy network isolation without the constraints of physical hardware * SDN firewalls (security groups in cloud computing) apply to assets based on more flexible criteria than hardware firewalls",
    "topic": "17.3.1",
    "type": "multi"
  },
  {
  ...
  {
    "id": 137,
    "question": "Which role in a data governance program is responsible for compliance, assigning classifications, and determining access criteria for information assets?",
    "options": [
      "data controller",
  ...
  {
    "id": 139,
    "question": "A company manages sensitive customer data and currently uses username and passphrase authentication. They want to mitigate the risk of employee credential compromise. What should they do?",
    "options": [
  ...
  {
    "id": 140,
    "question": "As a cybersecurity analyst, which organization maintains the weekly digest called NewsBites?",
    "options": [
      "MITRE",
      "CIS",
      "(ISC)2",
  ...
  },
  {
    ...
    "matchPairs": [
      [
        "FireEye",
        "blocks attacks across the web and email threat vectors, and latent malware that resides on file shares"
      ],
      [
        "Cisco Talos",
        "collects information about active, existing, and emerging threats and provides comprehensive protection against these attacks to subscribers"
      ],
      [
        "MITRE Corporation",
        "creates and maintains a catalog of known security threats called Common Vulnerabilities and Exposures (CVE)"
      ],
      [
        "DHS Automated Indicator Sharing",
        "provides a real-time exchange of cyber threat indicators between the U.S. Government and the private sector"
      ]
    ]
  },
  {
    "id": 142,
    "question": "Which four metrics are key considerations in a Business Impact Analysis (BIA)?",
    "options": [
  ...
  {
    "id": 143,
    "question": "An audit revealed weak passwords, stolen credentials, and phishing attacks. What single measure can mitigate all these risks?",
    "options": [
  ...
  {
    "id": 144,
    "question": "An IT cybersecurity technician wants to conduct a layer-3 port scan and use decoy hosts on the same LAN to mask the scan source. Which tool should be used?",
    "options": [
      "Tripwire",
      "SIEM",
      "Nmap",
  ...
  {
    "id": 146,
    "question": "Which type of cyber threat could cause electrical power outages?",
    "options": [
      "Sabotage",
      "Hardware failure",
  ...
  {
    "id": 147,
    "question": "A threat actor uses a Smurf attack to overwhelm a target host. What type of threat is this?",
    "options": [
  ...
  {
    "id": 148,
    "question": "Which statement describes a characteristic of WLANs?",
    "options": [
  ...
  {
    "id": 149,
    "question": "What cybersecurity mitigation phase involves limiting the spread of a worm infection to areas of the network that are already affected?",
    "options": [
      "inoculation",
      "quarantine",
      "containment",
  ...
  {
    "id": 151,
    "question": "Which security strategy applies the terms layering, limiting, and obscurity?",
    "options": [
      "defense-in-depth",
      "physical security",
      "traffic filtering",
    ...
    "multiple": false,
    "explanation": "This strategy involves creating different layers of protection to ensure data and infrastructure remain secure, which includes the terms layering, limiting, and obscurity.",
    "topic": "11.1.11",
    "type": "mcq"
  },
  {
    ...
    "multiple": false,
    "explanation": "Many of these SoC devices have poor authentication and/or they cannot be upgraded or patched. Due to the nature of these devices, a level of implied trust is necessary since there is no formal program in place to verify security controls.",
    "topic": "12.7.4",
    "type": "mcq"
  },
  {
    "id": 153,
    "question": "What is a feature of a Zero Trust approach to network security?",
    "options": [
  ...
  {
    "id": 155,
    "question": "What actions are employed when configuring an IOS ZPF (Zone-Based Policy Firewall) for network traffic?",
    "options": [
      "policy-map",
      "zone pair",
      "class-map",
    ...
    "multiple": false,
    "explanation": "The actions used in an IOS ZPF: – Inspect: Performs stateful packet inspection. – Drop: Blocks traffic (with optional logging). – Pass: Allows traffic without state tracking. The “inspect action” is one of these core actions applied to network traffic. The other options (zone pair, class-map, policy-map) are configuration components used to define policies but are not actions directly applied to traffic.",
    "topic": "16.2.1",
    "type": "mcq"
  },
  {
    "id": 156,
    "question": "How can three algorithms in the SSL/TLS cipher suite be updated if cryptanalysis reveals flaws? (Choose three.)",
    "options": [
      "encryption algorithm",
      "AAA algorithm",
  ...
  {
    "id": 160,
    "question": "Refer to the exhibit. A router has an existing ACL that permits all traffic from the 172.16.0.0 network. The administrator attempts to add a new ACE to the ACL that denies packets from host 172.16.0.1 and receives the error message that is shown in the exhibit. What action can the administrator take to block packets from host 172.16.0.1 while still permitting all other traffic from the 172.16.0.0 network?",
    "options": [
      "Add a deny any any ACE to access-list 1.",
      "Create a second access list denying the host and apply it to the same interface.",
      "Manually add the new deny ACE with a sequence number of 15.",
  ...
  },
  {
    ...
    "multiple": false,
    "explanation": "The basic best practices for device hardening are as follows: Ensure physical security. Minimize installed packages. Disable unused services. Use SSH and disable the root account login over SSH. Keep the system updated. Disable USB auto-detection. Enforce strong passwords. Force periodic password changes. Keep users from re-using old passwords. Review logs regularly.",
    "topic": "8.4.2",
    "type": "mcq"
  },
  {
  ...
  },
  {
    ...
    "multiple": false,
    "explanation": "The three steps of risk assessment in order are as follows: 1. Identify threats and vulnerabilities and the matching of threats with vulnerabilities. 2. Establish a baseline to indicate risk before security controls are implemented. 3. Compare to an ongoing risk assessment as a means of evaluating risk management effectiveness.",
    "topic": "25.3.1",
    "type": "mcq"
  },
  {
  ...
  {
    "id": 176,
    "question": "After host A receives a web page from server B, host A terminates the connection with server B. Match each option to its correct step in the normal termination process for a TCP connection.",
    "options": [],
    "correct": [],
    "multiple": false,
  ...
  {
    "id": 177,
    "question": "Match the tabs of the Windows 10 Task Manager to their functions.",
    "options": [],
    "correct": [],
    "multiple": false,
  ...
  },
  {
    ...
    "multiple": false,
    "explanation": "True Positive: The alert has been verified to be an actual security incident. False Positive: The alert does not indicate an actual security incident. Benign activity that results in a false positive is sometimes referred to as a benign trigger. True Negative: No security incident has occurred. The activity is benign. False Negative: An undetected incident has occurred.",
    "topic": "21.2.2",
    "type": "mcq"
  },
  {
  ...
  },
  {
    ...
    "multiple": true,
    "explanation": "This scenario is a typical SaaS cloud service model. The company is responsible for data security. The company also shares the security responsibilities for endpoints and identity management in the cloud with AWS. AWS is responsible for physical infrastructure implementation and security. Some techniques that the company should consider to protect VMs in the cloud include: * Plan subnet placement. * Disable unneeded ports and services. * Enforce account management policies. * Install antivirus/anti-malware software and keep it updated. * Install host-based/software firewalls and IDS/IPS.",
    "topic": "17.6.1",
    "type": "multi"
  },
  {
  ...
  {
    "id": 187,
    "question": "An IT cybersecurity technician wants to conduct a layer three port scanning on the network systems but wishes to use decoy hosts on the same LAN as target hosts to mask the source of the scan. What security tool functions allow the technician to do this?",
    "options": [
      "Tripwire",
      "SIEM",
      "Superscan",
  ...
  {
    "id": 188,
    "question": "Which file system is for Mac OS X computers, and Windows users may use third-party software to open and save files from this file system?",
    "options": [
      "EXT",
      "NTFS",
      "HFS+",
  ...
  {
    "id": 189,
    "question": "What is the need for data integrity in forums and personal pages on social media?",
    "options": [
      "high",
      "critical",
      "low",
  ...
  {
    "id": 193,
    "question": "Place the steps for configuring zone-based policy (ZPF) firewalls in order from first to last.",
    "options": [],
    "correct": [
      1
    ],
  ...
  },
  {
    ...
    "multiple": false,
    "explanation": "Alerts can be classified as follows: True Positive: The alert has been verified to be an actual security incident. False Positive: The alert does not indicate an actual security incident. Benign activity that results in a false positive is sometimes referred to as a benign trigger. An alternative situation is that an alert was not generated. The absence of an alert can be classified as: True Negative: No security incident has occurred. The activity is benign. False Negative: An undetected incident has occurred.",
    "topic": "21.2.2",
    "type": "mcq"
  },
  {
  ...
  {
    "id": 218,
    "question": "As a Cybersecurity Analyst, it is very important to keep current. It was suggested by some colleagues that NewsBites contains many good current articles to read. What network security organization maintains this weekly digest?",
    "options": [
      "CIS",
      "SANS",
      "(ISC)2",
  ...
  },
  {
    ...
    "matchPairs": [
      [
        "Data controller",
        "A person who determines the purposes for which and how to process personal data."
      ],
      [
        "Data custodian",
      ...
      [
        "Data processor",
        "A person or organization processes personal data on behalf of the data controller."
      ],
      [
        "Data steward",
        "A person who ensures that data supports an organization’s business needs and meets regulatory requirements."
      ],
      [
        "Data owner",
  ...
  {
    "id": 221,
    "question": "Which device is the first line of defense in a defense-in-depth approach to network security?",
    "options": [
      "edge router",
      "internal router",
      "switch",
    ...
    "multiple": false,
    "explanation": "Edge router: The first line of defense is known as an edge router. The edge router has a set of rules specifying which traffic it allows or denies. It passes all connections that are intended for the internal LAN to the firewall.",
    "topic": "11.1.9",
    "type": "mcq"
  },
  {
    "id": 222,
    "question": "Refer to the exhibit. Which technology generated the event log?",
    "options": [
      "Wireshark",
      "web proxy",
      "syslog",
  ...
  {
    "id": 230,
    "question": "Which statement describes a DNS stealth attack using threat actors’ double IP flux technique?",
    "options": [
  ...
  },
  {
    ...
    "multiple": false,
    "explanation": "There are six steps in the vulnerability management life cycle: Discover Prioritize assets Assess Report Remediate Verify",
    "topic": "",
    "type": "mcq"
  },
  {
  ...
  },
  {
    ...
    "multiple": false,
    "explanation": "An organization needs to establish clear and detailed security policies. Some of these policies are: Password policy- Defines minimum password requirements, such as the number and type of characters used and how often they need to be changed. Acceptable use policy- Highlights a set of rules that determine access to and use of network resources. It may also define the consequences of policy violations. Remote access policy- Sets out how to remotely connect to the internal network of an organization and explains what information is remotely accessible. Data policy- Sets out measurable rules for processing data within an organization, such as specifying where data is stored, how data is classified, and how data is handled and disposed of.",
    "topic": "",
    "type": "mcq"
  },
  {
  ...
  {
    "id": 242,
    "question": "Which statement describes the characteristics of intrusion detection and intrusion prevention systems?",
    "options": [
  ...
  {
    "id": 243,
    "question": "What is the function provided by the Burpsuite tool in Kali Linux?",
    "options": [
      "penetration test",
      "managing",
      "scanning",
  ...
  {
    "id": 244,
    "question": "Which three aspects of an organization must cybersecurity analysts identify before developing a comprehensive security policy? (Choose three.)",
    "options": [
      "security budget",
  ...
  {
    "id": 245,
    "question": "Which two security alert classifications do cybersecurity analysts prefer? (Choose two.)",
    "options": [
      "true positive",
      "true negative",
      "false positive",
    ...
    "multiple": true,
    "explanation": "* **True positives** are the desired type of alert. They mean that the rules that generate alerts have worked correctly. * **False positives** are not desirable. Although they do not indicate that an undetected exploit has occurred, they are costly because cybersecurity analysts must investigate false alarms; therefore, time is taken away from investigation of alerts that indicate true exploits. * **True negatives** are desirable. They indicate that benign normal traffic is correctly ignored, and erroneous alerts are not being issued. * **False negatives** are dangerous. They indicate that exploits are not being detected by the security systems that are in place. These incidents could go undetected for a long time, and ongoing data loss and damage could result.",
    "topic": "",
    "type": "multi"
  },
  {
    "id": 246,
    "question": "A network security engineer is examining the Zone-based Policy Firewall configuration on a Cisco router and observes the following output:",
    "options": [
      ...
      "6.2.3.8 Packet Tracer – Router and Switch Redundancy (Answers Solution)",
      ...
      "3.5.5 Packet Tracer – Configure a Remote Access VPN Client Answers",
      "5.4.2 Risk Management and Security Controls Quiz Answers",
      "7.7.2 Cloud Security Quiz Answers",
      "1.5.3.5 Packet Tracer – Creating a Cyber World (Answers Solution)"
    ],
    "correct": [
      1
    ],
